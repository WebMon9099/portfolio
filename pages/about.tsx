            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <div className='w-full h-full flex items-center justify-center md:pr-20'>
                <div className='text-white text-12 md:text-lg font-medium '>
                  ...
                  My name is Artem Kolodiazhnyi and I&apos;m a Professional Full Stack Developer.<br/>
                  I have been working in web and mobile development for 8+ years.<br/>
                  My projects include building UI for web and mobile, Backend implementation, CMS development, 3rd party API integration, Web crawling, and Blockchain.<br/>
                  <div className='h-3'></div>
                  The things I love:<br/>
                  &nbsp;&nbsp;- Challenge something new, Learning New Skill and Improve MYSELF<br/>
                  &nbsp;&nbsp;- Build Trust and Long-Term Relationship<br/>
                  &nbsp;&nbsp;- React/Next/Vue, Python/Flask/Django, PHP/Laravel, web3.js<br/>
                  &nbsp;&nbsp;- Football, Billiards, Reading<br/>
                  <div className='h-3'></div>
                  The things I hate:<br/>
                  &nbsp;&nbsp;- No Response Too Long<br/>
