            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <div className='w-full h-full flex items-center justify-center md:pr-24'>
                <div className='text-white text-sm md:text-lg font-medium'>
                  ...
                  <div className='my-1'>- Tailwind CSS, Sass, Scss, Material-UI, Ant-Design</div>
                  <div className='my-1'>- Pixel-Perfect/Mobile Responsive Web UI</div>
                  <div className='my-1'>- Wordpress, Shopify</div>
                  <div className='my-1'>- PHP/Laravel, Node/Express, Python/Django/Flask</div>
                  <div className='my-1'>- React, Redux, Next.js, Vue.js, Nuxt.js, Web3.js</div>
                  <div className='my-1'>- REST API, GraphQL</div>
                  <div className='my-1'>- TensorFlow/Machine Learning/Artificial Intelligence</div>
                  <div className='my-1'>- Ethereum, Smart contract, Solidity/Hardhat, Solana, Rust/Anchor, DApp, Defi</div>
                  <div className='my-1'>- AWS, Google Cloud Platform</div>
                  <div className='my-1'>- Web Scraping and Crawling, Automation</div>
                  <div className='my-1'>- MySQL, PostgreSQL, MongoDB, Redis, SQLite</div>
                  <div className='my-1'>- Version Control : Github/GitLab/BitBucket</div>
                  <div className='mt-4 text-base md:text-22'>Hourly Rate: <b className='text-green-400 font-semibold'>$50~70</b> depending on difficulty</div>
                </div>
              </div>
            </div>
          </div>
